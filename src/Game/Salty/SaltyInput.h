...
// NOTE: This was directly copy pasted from 'SDL_scancode.h', renaming stuff like SDL_SCANCODE_A -> KEY_A
enum EKeyButtons {
    KEY_UNKNOWN = 0,
...
class Input {
    public:
        ...
        static bool KeyDown[NUM_KEYS];
        // Keys that were pressed previously and not lifted
        static bool KeyHeld[NUM_KEYS];
        // Keys that were released this frame
        static bool KeyUp[NUM_KEYS];
